...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.setVec3("pointLights[0].diffuse", 0.0f, 0.0f, 1.0f);
        ...
        lightingShader.setVec3("pointLights[1].diffuse", 0.0f, 0.0f, 1.0f);
